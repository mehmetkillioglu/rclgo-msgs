...
func init() {
	typemap.RegisterService("gazebo_msgs/DeleteEntity", DeleteEntityTypeSupport)
}
...
func (s _DeleteEntityTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_service_type_support_handle__gazebo_msgs__srv__DeleteEntity())
}
